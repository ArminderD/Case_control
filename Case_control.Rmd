...
* Inspect the dataset using commands, such as`summary` 
...
This command calculates number of cases, attack rate among cases and controls, odds ratio, 95%CI interval,  p-value for each variable of varlist.  The result table could be sorted by p-value, odds ratio, attack rates. 
